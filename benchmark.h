    ...
    static auto measure(Run& run, const InputBase& input) {
      ...
      static std::unordered_map<std::string, Fn*> fns{
        {"i-naive", measure2<i_naive(record_bytes), record_bytes>},
          ...
          {"b-naive", measure2<b_naive<record_bytes>, record_bytes>},
          {"b-lin", measure2<b_lin(record_bytes), record_bytes>},
          {"b11000", measure2<Binary<record_bytes, true, true, false, false>, record_bytes>},
          {"b01000", measure2<Binary<record_bytes, false, true, false, false>, record_bytes>},
          {"b00000", measure2<Binary<record_bytes, false, false, false, false>, record_bytes>},
          {"b00100", measure2<Binary<record_bytes, false, false, true, false>, record_bytes>},
          {"b00110", measure2<Binary<record_bytes, false, false, true, true>, record_bytes>},
          {"b11001", measure2<Binary<record_bytes, true, true, false, false,32>, record_bytes>},
          {"b01001", measure2<Binary<record_bytes, false, true, false, false,32>, record_bytes>},
          {"b00001", measure2<Binary<record_bytes, false, false, false, false,32>, record_bytes>},
          {"b00101", measure2<Binary<record_bytes, false, false, true, false,32>, record_bytes>},
          {"b00111", measure2<Binary<record_bytes, false, false, true, true,32>, record_bytes>},
          {"lr1100", measure2<LR<record_bytes, true, true, false>, record_bytes>},
          {"lr0100", measure2<LR<record_bytes, false, true, false>, record_bytes>},
          {"lr0000", measure2<LR<record_bytes, false, false, false>, record_bytes>},
          {"lr0011", measure2<LR<record_bytes, true, true, false>, record_bytes>},
          {"lr1101", measure2<LR<record_bytes, true, true, false,32>, record_bytes>},
          {"lr0101", measure2<LR<record_bytes, false, true, false,32>, record_bytes>},
          {"lr0001", measure2<LR<record_bytes, false, false, false,32>, record_bytes>},
          {"lr0011", measure2<LR<record_bytes, true, true, false,32>, record_bytes>},
          //{"i-no-reuse-0", measure2<i_no_reuse(record_bytes, 0), record_bytes>},
          //{"i-no-reuse-8", measure2<i_no_reuse(record_bytes, 8), record_bytes>},
          {"i-no-reuse-16", measure2<i_no_reuse(record_bytes, 16), record_bytes>},
          //{"i-no-reuse-32", measure2<i_no_reuse(record_bytes, 32), record_bytes>},
          //{"i-no-reuse-64", measure2<i_no_reuse(record_bytes, 64), record_bytes>},
          ...
          //{"i-branch", measure2<i_branch(record_bytes), record_bytes>},
          //{"i-hybrid", measure2<i_hybrid(record_bytes), record_bytes>},
      };
